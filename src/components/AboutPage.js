    ...
    <div className=" py-12 px-6 lg:px-24 pt-28 pb-28 ">
     ...
     <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-12">
          Welcome to Our E-Commerce Store! We are committed to bringing you the
          best products at unbeatable prices. Our mission is to provide an
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-8">
        ...
        <div className="w-full lg:w-1/3 bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-600">
            We value integrity, customer satisfaction, and innovation. Our team
            is dedicated to ensuring that you have a positive shopping
